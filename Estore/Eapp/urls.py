...
urlpatterns = [
    ...
    path('passwordchangedone/',auth_view.PasswordResetDoneView.as_view(template_name='passwordchangedone.html'),name="passwordchangedone"),
...
# showwishlist
path('wishlist/',views.show_watchlist, name='showwishlist'),
...
admin.site.site_header = "Kazim Shop"
admin.site.site_title = "Kazim Shop"
admin.site.site_index_title = "Welcome to Kazim Shop"